...
import { HandbagIcon, CoffeeIcon, DropIcon, TShirtIcon, PackageIcon } from '@phosphor-icons/react';
          ...
          return (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-1">
                <h3 className="font-serif text-lg text-stone-900 mb-1">{m.name}</h3>
                ...
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-stone-900">${m.price}</span>
                  <Button size="sm" variant="dark" onClick={() => handleAddToCart(m)}>
                    Add to Cart
                  </Button>
                </div>
              </div>
